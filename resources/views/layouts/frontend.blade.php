<x-layouts.base>
    <div class="bg-white">
        <header class="fixed top-0 z-40 w-full bg-white" x-data="{ mobileMenu: false }">
            ...
            {{-- Navigation --}}
            <nav class="relative z-10 mx-auto flex max-w-7xl items-center justify-between px-6 py-4 xl:px-8" aria-label="Global">
                <div class="flex flex-1 items-center">
                    <div class="flex w-full items-center justify-between lg:w-auto">
                        <a href="#">
                            <x-logo iconSize="w-6 h-6" />
                        </a>
                        <div class="-mr-3 flex items-center lg:hidden">
                            <button type="button" class="focus-ring-inset focus:ring-primary inline-flex items-center justify-center rounded-md p-2 text-gray-400 hover:bg-gray-100 focus:outline-none focus:ring-2" aria-expanded="false" x-show="!mobileMenu" x-on:click="mobileMenu = true">
                            ...
                            <button type="button" class="focus-ring-inset focus:ring-primary inline-flex items-center justify-center rounded-md p-2 text-gray-400 hover:bg-gray-100 focus:outline-none focus:ring-2" x-show="mobileMenu" x-on:click="mobileMenu = false">
                    ...
                    <div class="hidden space-x-10 lg:ml-20 lg:flex">
                ...
                <div class="hidden lg:flex lg:items-center lg:space-x-6">
                    <a href="{{ route('dashboard') }}" class="bg-primary hover:bg-primary-dark rounded-md border border-transparent px-6 py-2 text-base font-medium text-white"> Guest Portal </a>
                </div>
            </nav>
            ...
            <nav class="absolute inset-x-0 top-[80px] h-screen origin-top bg-black/75 lg:hidden" x-show="mobileMenu" :class="mobileMenu ? '' : ''" x-transition:enter="transition-colors ease-out duration-500" x-transition:enter-start="bg-black/0" x-transition:enter-end="bg-black/75" x-transition:leave="transition-colors ease-in duration-500" x-transition:leave-start="bg-black/75" x-transition:leave-end="bg-black/0">
                <div class="overflow-hidden" x-on:click.away="mobileMenu = false">
                    <div class="space-y-6 rounded-b-xl bg-gray-50 p-6" x-show="mobileMenu" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="-translate-y-full" x-transition:enter-end="translate-y-0" x-transition:leave="transition ease-in duration-300" x-transition:leave-start="translate-y-0" x-transition:leave-end="-translate-y-full">
                        <ul class="space-y-4">
                            <li>
                            ...
                            <hr class="py-1">
                            <li>
                                <a href="{{ route('dashboard') }}" class="bg-primary hover:bg-primary-dark block w-full rounded-md border border-transparent px-4 py-2 text-center font-medium text-white shadow">Guest Portal</a>
                            </li>
                        </ul>
                    </div>
                </div>
        ...
        {{-- Main --}}
        <main class="overflow-hidden pt-[75px]">
                ...
                <div class="xl:grid xl:grid-cols-3 xl:gap-8">
                    ...
                    <div class="mt-12 grid grid-cols-2 gap-8 xl:col-span-2 xl:mt-0">
                        <div class="md:grid md:grid-cols-2 md:gap-8">
                            <div>
                                <h3 class="text-sm font-semibold uppercase tracking-wider text-gray-200">Solutions</h3>
                            ...
                            <div class="mt-12 md:mt-0">
                                <h3 class="text-sm font-semibold uppercase tracking-wider text-gray-200">Support</h3>
                                <ul role="list" class="mt-4 space-y-4">
                                    <li>
                        ...
                        <div class="md:grid md:grid-cols-2 md:gap-8">
                            <div>
                                <h3 class="text-sm font-semibold uppercase tracking-wider text-gray-200">Company</h3>
                                <ul role="list" class="mt-4 space-y-4">
                                    <li>
                            ...
                            <div class="mt-12 md:mt-0">
                                <h3 class="text-sm font-semibold uppercase tracking-wider text-gray-200">Legal</h3>
                                <ul role="list" class="mt-4 space-y-4">
                                    <li>
