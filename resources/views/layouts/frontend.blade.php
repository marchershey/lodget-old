<x-layouts.base>
    <div class="bg-white">
        ...
        <footer class="bg-white">
            <div class="px-6 py-12 mx-auto overflow-hidden max-w-7xl lg:px-8">
                <nav class="flex flex-wrap justify-center -mx-5 -my-2" aria-label="Footer">
                    <div class="px-5 py-2">
                        <a href="#properties" class="text-base text-gray-500 hover:text-gray-900">Properties</a>
                    </div>
                    ...
                    <div class="px-5 py-2">
                        <a href="#contact" class="text-base text-gray-500 hover:text-gray-900">Get in touch</a>
                    </div>
                ...
                {{-- <div class="flex justify-center mt-8 space-x-6">
                    <a href="https://www.facebook.com/profile.php?id=100063454455920" class="text-gray-400 hover:text-gray-500">
                ...
                <p class="mt-8 text-base text-center text-gray-400">&copy; {{ date('Y') }} Serrate Rentals - All rights reserved.</p>
            </div>
        </footer>
