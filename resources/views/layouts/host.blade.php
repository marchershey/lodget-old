<x-layouts.base>
    ...
    <div class="relative flex flex-col min-h-screen" x-data="{ mobileMenu: false }">
        <!-- Navbar -->
        <nav class="flex-shrink-0 bg-primary">
            <div class="px-2 mx-auto max-w-7xl sm:px-4 lg:px-8">
                <div class="relative flex items-center justify-between h-16">
                    ...
                    <div class="flex lg:hidden">
                        <!-- Mobile menu button -->
                        <button type="button" class="inline-flex items-center justify-center p-2 text-indigo-400 rounded-md bg-primary hover:text-white hover:bg-primary focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-primary focus:ring-white" aria-controls="mobile-menu" aria-expanded="false" x-on:click="mobileMenu = !mobileMenu">
                            <span class="sr-only">Open main menu</span>
                            <svg class="block w-8 h-8" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true" x-show="!mobileMenu">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M4 6h16M4 12h8m-8 6h16" />
                            </svg>
                            <svg class="block w-8 h-8" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true" x-show="mobileMenu" x-cloak>
            ...
            <div class="lg:hidden" id="mobile-menu" x-show="mobileMenu" x-cloak x-on:click.away="mobileMenu = false">
                <div class="px-2 pt-2 pb-3">
                    <a href="{{ route('host.dashboard') }}" class="block px-3 py-2 text-base font-medium text-white rounded-md bg-primary-dark">Dashboard</a>
                    <a href="#" class="block px-3 py-2 mt-1 text-base font-medium rounded-md text-primary-muted hover:bg-primary">Support</a>
                </div>
                <div class="pt-4 pb-3 border-t border-primary-dark">
                    <div class="px-2">
                        <a href="#" class="block px-3 py-2 text-base font-medium rounded-md text-primary-muted hover:bg-primary">Your Profile</a>
                        <a href="#" class="block px-3 py-2 mt-1 text-base font-medium rounded-md text-primary-muted hover:bg-primary">Settings</a>
                        <a href="{{ route('auth.logout') }}" class="block px-3 py-2 mt-1 text-base font-medium rounded-md text-primary-muted hover:bg-primary">Sign out</a>
                    </div>
                </div>
            </div>
        </nav>
