<x-layouts.host>
    ...
    <div class="flex flex-col space-y-10">
            ...
            <div class="hidden sm:block">
                <div class="border-b border-gray-200">
                    <nav class="flex -mb-px space-x-8" aria-label="Tabs">
                        ...
                        <a href="#" class="px-1 py-4 text-sm font-medium text-gray-500 border-b-2 border-transparent hover:border-gray-300 hover:text-gray-700 whitespace-nowrap">Overview</a>
                        <a href="#" class="px-1 py-4 text-sm font-medium text-gray-500 border-b-2 border-transparent hover:border-gray-300 hover:text-gray-700 whitespace-nowrap">Accommodation</a>
                        <a href="#" class="px-1 py-4 text-sm font-medium text-indigo-600 border-b-2 border-indigo-500 whitespace-nowrap" aria-current="page">Team Members</a>
                        <a href="#" class="px-1 py-4 text-sm font-medium text-gray-500 border-b-2 border-transparent hover:border-gray-300 hover:text-gray-700 whitespace-nowrap">Billing</a>
                    </nav>
                </div>
            </div>
        </div>
        ...
        <div class="space-y-12 divide-y">
            ...
            <div class="grid grid-cols-1 pt-12 gap-x-8 gap-y-8 md:grid-cols-3">
                <div class="px-4 sm:px-0">
