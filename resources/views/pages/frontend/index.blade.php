<x-layouts.frontend>
    ...
    <div class="bg-white">
        <header class="relative" x-data="{ mobileMenu: false }">
                    ...
                    <div class="flex items-center flex-1">
                        <div class="flex items-center justify-between w-full lg:w-auto">
                            ...
                            <div class="flex items-center -mr-2 lg:hidden">
                                <button type="button" class="inline-flex items-center justify-center p-2 text-gray-400 rounded-md bg-gray-50 hover:bg-gray-100 focus:outline-none focus:ring-2 focus-ring-inset focus:ring-teal-500" aria-expanded="false" x-on:click="mobileMenu = true">
            ...
            {{-- Mobile Menu --}}
            <div class="absolute inset-x-0 top-0 z-30 h-screen p-2 transition origin-top transform bg-black bg-opacity-75 lg:hidden" x-show="mobileMenu">
                <div class="overflow-hidden bg-white rounded-lg shadow-lg ring-1 ring-black ring-opacity-5" x-on:click.away="mobileMenu = false">
                    <div class="flex items-center justify-between px-5 pt-4">
                        <div class="-ml-1">
                            <x-logo />
                        </div>
                        <div class="-mr-2">
                            <button type="button" class="inline-flex items-center justify-center p-2 text-gray-400 bg-white rounded-md hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-teal-500" x-on:click="mobileMenu = false">
                    ...
                    <div class="pt-5 pb-6">
                        <div class="px-2 space-y-1">
                            <a href="#" class="block px-3 py-2 text-lg font-medium text-gray-900 rounded-md hover:bg-gray-50">Properties</a>
                            <a href="#" class="block px-3 py-2 text-lg font-medium text-gray-900 rounded-md hover:bg-gray-50">Get in touch</a>
                        </div>
                        <div class="px-5 mt-6">
            ...
            <div class="bg-gray-50">
                <div class="py-24 lg:py-32">
                    <div class="relative z-10 pl-4 pr-8 mx-auto max-w-7xl sm:px-6 lg:px-8">
                        ...
                        <p class="max-w-3xl mt-6 text-xl text-gray-500">Vel nunc non ut montes, viverra tempor. Proin lectus nibh phasellus morbi non morbi. In elementum urna ut volutpat. Sagittis et vel et fermentum amet consequat.</p>
                    </div>
                </div>
            </div>
