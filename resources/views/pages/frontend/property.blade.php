                ...
                <div class="w-full max-w-2xl mx-auto mt-16 lg:max-w-none lg:mt-0 lg:col-span-4">
                    <div>
                        <div class="border-b border-gray-200">
                            <div class="flex -mb-px space-x-8" aria-orientation="horizontal" role="tablist">
                                ...
                                <button id="tab-reviews" class="py-6 text-sm font-medium text-gray-700 border-b-2 border-transparent hover:text-gray-800 hover:border-gray-300 whitespace-nowrap" aria-controls="tab-panel-reviews" role="tab" type="button">Customer Reviews</button>
                                <button id="tab-faq" class="py-6 text-sm font-medium text-gray-700 border-b-2 border-transparent hover:text-gray-800 hover:border-gray-300 whitespace-nowrap" aria-controls="tab-panel-faq" role="tab" type="button">FAQ</button>
                                <button id="tab-license" class="py-6 text-sm font-medium text-gray-700 border-b-2 border-transparent hover:text-gray-800 hover:border-gray-300 whitespace-nowrap" aria-controls="tab-panel-license" role="tab" type="button">License</button>
                            </div>
                        </div>
                    ...
                    -->
                        ...
                        <div id="tab-panel-license" class="pt-10" aria-labelledby="tab-license" role="tabpanel" tabindex="0">
                            ...
                            <div class="prose-sm prose text-gray-500 max-w-none">
                                <h4>Overview</h4>
