            ...
            <form action="{{ route('guest.profile.submit-profile') }}" method="POST">
                ...
                <div class="panel-body">
                    ...
                    <div class="panel-action-spacing">
                        <button type="submit" class="w-auto button">Update Profile</button>
                        <a href="/dashboard" class="w-auto button button-light">Cancel</a>
                    </div>
                </div>
            </form>
        </div>
        ...
        <div class="panel">
            ...
            <form action="{{ route('guest.profile.submit-password') }}" method="POST">
                ...
                <div class="panel-body">
                    ...
                    <div class="panel-action-spacing">
                        <button type="submit" class="w-auto button">Update Password</button>
                        <a href="/dashboard" class="w-auto button button-light">Cancel</a>
                    </div>
                </div>
            </form>
