<x-layouts.minimal>
    ...
    {{-- form --}}
    <form class="space-y-6" wire:submit="submitRegistration()">
        <div class="flex space-x-3">
            <div>
                <label for="first_name" class="input-label">First name</label>
                <input wire:model.live="first_name" id="first_name" name="first_name" type="text" autocomplete="first_name" class="capitalize input-text" required>
            </div>
            <div>
                <label for="last_name" class="input-label">Last name</label>
                <input wire:model.live="last_name" id="last_name" name="last_name" type="text" autocomplete="last_name" class="capitalize input-text" required>
            </div>
        </div>

        <div>
            <label for="email" class="input-label">Email address</label>
            <input wire:model.live="email" id="email" name="email" type="email" autocomplete="email" class="input-text" required>
        </div>

        <div>
            <label for="password" class="input-label">Password</label>
            <input wire:model.live="password" id="password" name="password" type="password" autocomplete="current-password" class="input-text" required>
        </div>
        <div>
            <label for="password" class="input-label">Confirm password</label>
            <input wire:model.live="password_confirmation" id="password_confirmation" name="password_confirmation" type="password" autocomplete="current-password" class="input-text" required>
        </div>

        <div>
            <label for="birthdate" class="input-label">Birthdate</label>
            <input wire:model.live="birthdate" id="birthdate" name="birthdate" type="date" autocomplete="birthdate" class="input-text" required>
        </div>
        ...
        <div class="flex items-center">
            <input wire:model.live="agreement" id="agreement" name="agreement" type="checkbox" class="input-checkbox">
