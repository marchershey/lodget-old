                ...
                <div class="relative px-4 pt-5 pb-4 overflow-hidden text-left transition-all transform bg-white rounded-lg shadow-xl sm:my-8 sm:w-full sm:max-w-lg sm:p-6">
                    ...
                    <div class="flex items-center justify-end mt-5 sm:mt-4">
                        <div wire:loading.remove class="sm:flex sm:flex-row-reverse">
                            <button x-on:click="confirmCancel" type="button" class="inline-flex justify-center w-full px-4 py-2 text-base font-medium text-white bg-red-600 border border-transparent rounded-md shadow-sm hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 sm:ml-3 sm:w-auto sm:text-sm">Yes, cancel my reservation</button>
