    ...
    <ul role="list" class="flex flex-col flex-1 gap-y-7">
        <li>
            <ul role="list" class="-mx-2 space-y-1">
                <li>
                    <a href="{{ route('host.dashboard') }}" class="flex px-4 py-2 -mx-4 text-sm font-medium leading-6 border-l-4 group gap-x-3 {{ request()->routeIs('host.dashboard') ? 'bg-gray-800 border-primary text-white' : 'border-gray-900 text-muted hover:bg-gray-800 hover:text-white hover:border-gray-800' }}">
                ...
                <li>
                    <a href="{{ route('host.test') }}" class="flex px-4 py-2 -mx-4 text-sm font-medium leading-6 border-l-4 group gap-x-3 {{ request()->routeIs('host.test') ? 'bg-gray-800 border-primary text-white' : 'border-gray-900 text-muted hover:bg-gray-800 hover:text-white hover:border-gray-800' }}">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 shrink-0" width="40" height="40" viewBox="0 0 24 24" stroke-width="1.75" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                            <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                ...
                <li>
                    <a href="#" class="flex px-4 py-2 -mx-4 text-sm font-medium leading-6 border-l-4 group gap-x-3 {{ request()->routeIs('host.test') ? 'bg-gray-800 border-primary text-white' : 'border-gray-900 text-muted hover:bg-gray-800 hover:text-white hover:border-gray-800' }}">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 shrink-0" width="40" height="40" viewBox="0 0 24 24" stroke-width="1.75" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                            <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                ...
                <li>
                    <a href="{{ route('host.settings.general') }}" class="flex px-4 py-2 -mx-4 text-sm font-medium leading-6 border-l-4 group gap-x-3 {{ request()->routeIs('host.settings.*') ? 'bg-gray-800 border-primary text-white' : 'border-gray-900 text-muted hover:bg-gray-800 hover:text-white hover:border-gray-800' }}">
