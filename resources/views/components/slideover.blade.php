                ...
                <div class="w-screen max-w-md pointer-events-auto">
                    <div class="flex flex-col h-full bg-gray-100 shadow-2xl">
                        ...
                        <div class="flex justify-between flex-shrink-0 bg-white border-t page-padding-sm">
                            <button wire:click="cancel" class="button-sm laptop:button button-muted">Cancel</button>
                            <button wire:click="{{ $action }}" wire:loading.attr="disabled" wire:target="{{ $action }}" class="button-sm laptop:button button-primary">
