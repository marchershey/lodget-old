<div>
    ...
    @endif
    <select wire:model.lazy="{{ $wiremodel }}" wire:target="{{ $wiretarget }}" wire:loading.attr="disabled" name="{{ $label }}" id="{{ $wiremodel }}" class="input-select @error($wiremodel) !ring-red-500 @enderror">
        <option></option>
